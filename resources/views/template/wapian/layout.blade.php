...
<head>
    ...
    <link rel="stylesheet" href="/public/static2/wapian/css/bootstrap.min.css"/>
    <link href="/public/static2/wapian/css/swiper.min.css" rel="stylesheet" type="text/css">
    <link href="/public/static2/wapian/css/iconfont.css" rel="stylesheet" type="text/css"/>
    <link href="/public/static2/wapian/css/blackcolor.css" rel="stylesheet" type="text/css"/>
    <link href="/public/static2/wapian/css/style.min.css" rel="stylesheet" type="text/css"/>
    <script type='text/javascript' src="/public/static2/wapian/js/swiper.min.js"></script>
    <script src="/public/static2/wapian/js/jquery.min.js"></script>
    <script type='text/javascript' src="/public/static2/wapian/js/system.js"></script>
    <script type="text/javascript" src="/public/static2/wapian/js/su.js"></script>
    <!--[if lt IE 9]>
    <script src="/public/static2/wapian/js/html5.js"></script><![endif]-->
    @section('other')
     @show
    <style>
        #ys {
...
<div class="hy-head-menu">
    <div class="container">
        <div class="row">
            <div class="item">
                <div class="logo">
                    <a class="hidden-sm hidden-xs" href="/"><img src="/public/static2/wapian/images/logo.png" height="50px" width="150px"/></a>
                </div>
