                    ...
                    <div class="item">
                        <ul class="clearfix">
                         ...
                         <div class="col-md-2 col-sm-3 col-xs-4">
							<a class="videopic lazy" href="/play/{{$dy['url']}}.html" title="{{$dy['title']}}" src="{{$dy['img']}}" onclick="jilu(this)" style="background: url({{$dy['img']}}) no-repeat; background-position:50% 50%; background-size: cover;">
