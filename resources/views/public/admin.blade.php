...
<head>
    ...
    <link rel="stylesheet" href="{{URL::asset('css/fonts/linecons/css/linecons.css')}}">
    <link rel="stylesheet" href="{{URL::asset('css/fonts/linecons/css/linecons.css')}}/public/static/admin/assets/css/fonts/fontawesome/css/font-awesome.min.css">
